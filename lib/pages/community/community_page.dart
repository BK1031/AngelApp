...
class _CommunityPageState extends State<CommunityPage> {
                ...
                child: Column(
                  ...
                  children: [
                    Card(
                      ...
                      child: InkWell(
                        onTap: () {
                          router.navigateTo(context, "/community/${event.snapshot.key}", transition: TransitionType.cupertino);
                        },
                        child: new Container(
                            height: 143,
                            child: Padding(
  ...
  void AddNewPost() {
    router.navigateTo(
        context, "/community/new", transition: TransitionType.nativeModal);
  }
}